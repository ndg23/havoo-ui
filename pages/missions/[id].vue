<template>
  <div class="min-h-screen bg-white">
          ...
          <h3 class="text-xl font-bold text-gray-900 flex items-center gap-2">
            ...
            >
              ...
              <BaseButton
                ...
                size="lg"
                class="flex-1"
                @click="showAcceptModal = true; selectedProposal = proposal"
              >
                <template #leading>
              ...
              <BaseButton
                ...
                size="lg"
                class="flex-1"
                @click="showRejectModal = true; selectedProposal = proposal"
              >
                <template #leading>
    ...
    <!-- Modal Accepter -->
    <TransitionRoot appear :show="showAcceptModal" as="template">
      <Dialog as="div" class="relative z-50" @close="showAcceptModal = false">
        <TransitionChild
          as="template"
          enter="duration-300 ease-out"
          enter-from="opacity-0"
              ...
              <DialogPanel class="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all dark:bg-gray-800">
                <div class="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      Vous êtes sur le point d'accepter cette proposition. Cette action est définitive.
                    </p>
                  </div>
                </div>
                ...
                <div class="mt-6 flex justify-end gap-3">
                  ...
                  <BaseButton
                    ...
                    size="lg"
                    :loading="isSubmitting"
                    @click="acceptProposal(selectedProposal.id)"
                  >
                    Confirmer
                  </BaseButton>
                </div>
              ...
              <DialogPanel class="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all dark:bg-gray-800">
                <div class="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      Vous êtes sur le point de refuser cette proposition. Cette action est définitive.
                    </p>
                  </div>
                </div>
                ...
                <div class="mt-6 flex justify-end gap-3">
                  ...
                  <BaseButton
                    ...
                    size="lg"
                    :loading="isSubmitting"
                    @click="rejectProposal(selectedProposal.id)"
                  >
                    Confirmer
                  </BaseButton>
                </div>
...
// Ajouter les refs pour les modals
...
const acceptProposal = async (proposalId) => {
  try {
    ...
    showToast.success(
      ...
      'La mission démarre ! Vous trouverez les coordonnées de l\'expert dans les détails de la mission.'
    )
    ...
    setTimeout(() => {
      navigateTo(`/missions/${mission.value.id}/details`)
    }, 1500)
