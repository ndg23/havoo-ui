<template>
    <div class="min-h-screen bg-white flex">
      ...
      <div class="w-full lg:w-1/2 flex mx-auto flex-col justify-center p-6 sm:p-12">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <!-- Message d'erreur -->
          <div v-if="errorMessage" class="mb-4 bg-red-50 border border-red-200 text-red-600 rounded-lg p-3 text-sm">
            {{ errorMessage }}
          </div>
            ...
            <div>
              <div class="relative">
                <input 
                  ...
                  required 
                  class="block w-full px-4 py-3 border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent pr-10"
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // Ici, vous implémenteriez l'appel API pour la connexion
      ...
      errorMessage.value = 'Identifiants incorrects. Veuillez vérifier votre email et mot de passe.';
    } finally {
